# Install dependencies and customize sandbox for AI/ML algorithms
FROM node:21-slim
...
RUN git config --global user.email "algorithms@leverageai.com" &&     git config --global user.name "leverageai-algorithms"
